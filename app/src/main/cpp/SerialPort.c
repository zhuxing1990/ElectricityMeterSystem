...
//#include "com_example_x6_serialportlib_SerialPortJNI.h"
 ...
 * Method:    setSpeed
 * Signature: (II)I
 */JNIEXPORT jint JNICALL Java_com_example_x6_serialportlib_SerialPortJNI_setSpeed(
 ...
 * Method:    setParity
 * Signature: (IIII)I
 */JNIEXPORT jint JNICALL Java_com_example_x6_serialportlib_SerialPortJNI_setParity(
 ...
 * Signature: (I)I
 */
JNIEXPORT jobject JNICALL Java_com_example_x6_serialportlib_SerialPortJNI_openDev(
		JNIEnv *env, jobject thiz, jstring devnum, jint isNonblock) {
...
//	bzero(&cfg, sizeof(cfg));
    ...
    if(isNonblock) {
		LOGD("NONBLOCK");
		fd = open(dev, O_RDWR | O_NOCTTY | O_NDELAY); //O_NOCTTY | O_NDELAY //非阻塞
	} else{
		fd = open(dev, O_RDWR); //O_NOCTTY | O_NDELAY  //阻塞
	}
 ...
 * Method:    closeDev
 * Signature: (II)I
 */JNIEXPORT jint JNICALL Java_com_example_x6_serialportlib_SerialPortJNI_closeDev(
 ...
 */JNIEXPORT jint JNICALL Java_com_example_x6_serialportlib_SerialPortJNI_readBytes(
 ...
 */JNIEXPORT jboolean JNICALL Java_com_example_x6_serialportlib_SerialPortJNI_writeBytes(
 ...
 */
JNIEXPORT jobject JNICALL Java_com_example_x6_serialportlib_SerialPortJNI_open485Dev(
		JNIEnv *env, jobject thiz, jstring devnum, jint isNonblock) {
	return Java_com_example_x6_serialportlib_SerialPortJNI_openDev(env, thiz,
			devnum,isNonblock);
}
 ...
 */
JNIEXPORT jint JNICALL Java_com_example_x6_serialportlib_SerialPortJNI_close485Dev(
		JNIEnv *env, jobject thiz, jobject mfd) {
	return Java_com_example_x6_serialportlib_SerialPortJNI_closeDev(env, thiz,
			mfd);
}

JNIEXPORT jint JNICALL Java_com_example_x6_serialportlib_SerialPortJNI_set485mod(
