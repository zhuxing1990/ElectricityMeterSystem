...
/**
 * Created by ZhangZeZhi on 2018-03-14.
 */
...
public class SPUtils {
     ...
     * @param <T>      item 类型
     */
    public static <T> void setDataList(Context ctx,String key, List<T> datalist) {
        ...
        SPUtils.putString(ctx, key, strJson);
    }
     ...
     * @return list
     */
    public static <T> List<T> getDataList(Context ctx,String key, Class<T> cls) {
        List<T> datalist = new ArrayList<T>();
        String strJson = SPUtils.getString(ctx, key, null);
