...
// 获得本周一0点时间
    ...
    public static Date getLastMonth(){
        SimpleDateFormat sfmm = new SimpleDateFormat("yyyyMM");
        //日期
        SimpleDateFormat sfdd = new SimpleDateFormat("yyyyMMdd");
        //当前时间
        ...
        //为改变后的时间加上日期
        try {
            Date dateThree = sfdd.parse(sfmm.format(dateTwo)+"-05");
            return dateThree;
    ...
    public static long getDifference(Date endDate,Date lastMonth){
