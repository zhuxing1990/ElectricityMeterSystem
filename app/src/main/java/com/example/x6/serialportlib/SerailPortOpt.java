...
public class SerailPortOpt extends SerialPortJNI {
	...
	public FileDescriptor openDev(String devNum, boolean isNonBlock) {
		int i = isNonBlock?1:0;
		super.mFd = super.openDev(devNum,i);
		if (super.mFd == null) {
	...
	public FileDescriptor open485Dev(String devNum, boolean isNonBlock) {
        int i = isNonBlock?1:0;
		super.mFd = super.open485Dev(devNum,i);
		if (super.mFd == null) {
			Log.e(TAG, "native open returns null");
			return null;
		}
	...
	public boolean write485Bytes(byte[] buffer)throws Exception {
		boolean ret;
		super.set485mod(RS485Write);
		Log.d("write485Bytes", "length: " + buffer.length);
